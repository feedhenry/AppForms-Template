DraftItemView = ItemView.extend({
    ...
    templates: {
        ...
        item: '<td><%= name %></td> <td><%= id %></td> <td><%= timestamp %></td><td><button class="fh_appform_button_cancel button button-negative delete-item second_button btn btn-negative">Delete</button></td>'
