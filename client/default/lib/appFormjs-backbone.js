...
(function(_scope) {
    ...
    FieldCameraView = FieldView.extend({
        input: "<img class='imageThumb img-responsive' data-field='<%= fieldId %>' data-index='<%= index %>'  type='<%= inputType %>'>",
    ...
    FieldCheckboxView = FieldView.extend({
        ...
        choice: '<div class="checkbox"><label><%= choice %><input data-fieldId="<%= fieldId %>" <%= checked %> data-index="<%= index %>" name="<%= fieldId %>[]" type="checkbox" class="field checkbox" value="<%= value %>" ></label></div>',
    ...
    FieldRadioView = FieldView.extend({
        hidden_field: '<input  id="radio<%= id %>" type="" value="" data-type="radio">',
    ...
    var PageView = BaseView.extend({
        ...
        render: function() {
            ...
            this.$el.empty().addClass('fh_appform_page hidden col-xs-12');
    ...
    var FormView = BaseView.extend({
        ...
        initWithForm: function(form, params) {
            ...
            self.$el.find(self.elementNames.formContainer).append(self.templates.buttons);
            self.pageNum = 0;
        ...
        rebindButtons: function() {
            var self = this;
            this.$el.find("button.fh_appform_button_next").unbind().bind("click", function(e) {
                e.preventDefault();
                self.nextPage();
            });

            this.$el.find("button.fh_appform_button_previous").unbind().bind("click", function(e) {
                e.preventDefault();
                self.prevPage();
            });

            this.$el.find("button.fh_appform_button_saveDraft").unbind().bind("click", function(e) {
                e.preventDefault();
                self.saveToDraft();
            });
            this.$el.find("button.fh_appform_button_submit").unbind().bind("click", function(e) {
                e.preventDefault();
                self.submit();
            });
            this.checkPages();
    ...
    StepsView = Backbone.View.extend({
        ...
        render: function() {
            ...
            this.$el.append(_.template(self.templates.page_title));
        },
    ...
    var ConfigView = Backbone.View.extend({
        ...
        templates: {
            camera_options: '<div class="fh_appform_field_area config_camera col-xs-10 col-xs-offset-1"><div class="fh_appform_field_title"><h3>Camera</h3></div></div>',
            ...
            submission_options: '<div class="fh_appform_field_area config_submission col-xs-10 col-xs-offset-1"><div class="fh_appform_field_title"><h3>Submission</h3></div></div>',
            ...
            debugging_options: '<div class="fh_appform_field_area config_debugging col-xs-10 col-xs-offset-1"><div class="fh_appform_field_title"><h3>Debugging</h4></div></div>',
            ...
            log_panel: '<div class="hidden" id="_logsViewPanel">' +
                '<div class="col-xs-12"><button class="fh_appform_button_cancel btn btn-default" id="_closeViewBtn">Close</button></div>' +
        ...
        "viewLogs": function() {
            ...
            this.$el.find("#_logsViewPanel").removeClass("hidden");
        },
        "clearLogs": function() {
            var self = this;
        ...
        "closeViewLogs": function() {
            this.$el.find("#_logsViewPanel").addClass("hidden");
        },
        "events": {},
        "initialize": function(options) {
            this.options = this.options || options || {};
        ...
        "render": function() {
            ...
            _.each(this.templates, function(key, val) {
                html += _.template(key, props);
            });
            this.$el.append(html);
            return this;
        },
