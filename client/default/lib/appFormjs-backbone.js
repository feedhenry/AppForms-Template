...
FieldView = Backbone.View.extend({
  ...
  inputTemplate: "<div id='wrapper_<%= fieldId %>_<%= index %>' style='width:100%;margin-top: 10px;'> <div class='<%= required %> fh_appform_field_title fh_appform_field_numbering'> <%=index + 1%>.  </div> <div class='fh_appform_field_input_container' style='display: inline-block;float: right;width: 86%;margin-right:15px'>  <%= inputHtml %> <div class='fh_appform_errorMsg fh_appform_hidden'></div>  </div><br style='clear:both'/>    </div>",
